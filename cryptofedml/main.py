...
FLAGS.add_argument('--mode', choices=['train', 'test'], default='test')
# Hyper-parameters
...
FLAGS.add_argument('--resume', type=str, default="logs-708/ckpts/meta-learner-34000.pth.tar",
...
def main():
    ...
    # alicelearner_w_grad.load_state_dict(torch.load('./alicelearner.pth'))
    ...
    learner_dict = learner_w_grad.state_dict()
    torch.save(learner_dict, './sgdboblearner.pth')
    metalearner_dict = metalearner.state_dict()
    torch.save(metalearner_dict, './sgdbobmetalearner.pth')
