...
model_ATGDU_dis.load_state_dict(torch.load('./bobdisweight.pth'))

model_ATGDU.traingan("./bob", "bob", "bobs2.txt", 0)

torch.save(model_ATGDU_gen.state_dict(), './newBobndw.pth')